...
- No em dashes.
- **Go deep, not broad.** When researching formats, prioritise large-scale data-backed analyses (Buffer 52M+ posts, Socialinsider 70M+ posts, Metricool 39M+ posts) over anecdotal advice or small-sample observations. Every engagement statistic should have a dated source citation.
- **Data over opinions.** If sources conflict, present both data points with context rather than picking one. Flag single-source or anecdotal claims as "unverified."
