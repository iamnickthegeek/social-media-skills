...
Before formatting, read `references/bleeding-edge-formats.md` from the social-media-skills directory. Use the LinkedIn section to inform:
- Hook type priorities (number-led 31%, bold claim 27%, contrarian 18%)
- Optimal post length (180–250 words; 200–250 target)
- Tone guidance (conversational/DM-like beats thought-leadership grandstanding)
- CTA patterns (reply bait outperforms generic CTAs)
...
- Always read the format reference (Step 0) before formatting.
