...
Before analyzing, read `references/bleeding-edge-formats.md` from the social-media-skills directory. Use the LinkedIn benchmarks and cross-platform engagement table to:
- Compare the user's engagement rate against the 6.60% carousel benchmark and platform averages
- Evaluate format distribution against top-performer benchmarks (carousel 33%, image 29%, text 22%)
- Assess hook types and CTA patterns against known high-performer distributions
- Use the "What to Avoid" section to flag content that matches known underperformer patterns
...
- Always read the format reference (Step 0) before analyzing.
