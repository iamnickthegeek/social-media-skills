...
Before generating hooks, read `references/bleeding-edge-formats.md` from the social-media-skills directory. Use the LinkedIn section to inform:
- Hook type distribution of top performers: number-led (31%), bold claim (27%), contrarian (18%)
- Tone guidance (conversational/DM-like beats thought-leadership grandstanding)
- Prioritize these hook angles in the 6 variations
